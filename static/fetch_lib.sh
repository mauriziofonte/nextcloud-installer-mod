...
then
    if ! curl -sfL https://raw.githubusercontent.com/mauriziofonte/nextcloud-installer-mod/master/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/mauriziofonte/nextcloud-installer-mod/master/lib.sh -o /var/scripts/lib.sh
fi
