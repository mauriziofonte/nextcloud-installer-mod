...
then
    ...
    curl_to_dir "https://raw.githubusercontent.com/mauriziofonte/nextcloud-installer-mod/master/addons/deSEC" "hook.sh" "$SCRIPTS"/deSEC
    chmod +x "$SCRIPTS"/deSEC/hook.sh
    curl_to_dir "https://raw.githubusercontent.com/mauriziofonte/nextcloud-installer-mod/master/addons/deSEC" ".dedynauth" "$SCRIPTS"/deSEC
